...
public class PickBlockEnumFactory implements ConfigFactoryProvider {
    ...
    public void provideLoadFactories(ImmutableMap.Builder<Type, SeptFunction<String, ConfigEntry, Field, Object, Boolean, Object, Object, ConfigEntryHandler<?>>> immutableBuilder) {
        immutableBuilder.put(PickBlockEnum.class, ((id, configEntry, parentField, parentObject, isMultiplayerSynced, enumOrOrdinal, defaultEnum) ->
        {
            int enumOrdinal;
            if(enumOrOrdinal instanceof Integer ordinal) {
                ...
                enumOrdinal = ((PickBlockEnum) enumOrOrdinal).ordinal();
            }
            return new EnumConfigEntryHandler<PickBlockEnum>(id, configEntry, parentField, parentObject, isMultiplayerSynced, enumOrdinal, ((PickBlockEnum) defaultEnum).ordinal(), PickBlockEnum.class);
        }));
    }

    @Override
    public void provideSaveFactories(ImmutableMap.Builder<Type, Function<Object, Object>> immutableBuilder) {
        immutableBuilder.put(PickBlockEnum.class, enumEntry -> enumEntry);
    }
}
